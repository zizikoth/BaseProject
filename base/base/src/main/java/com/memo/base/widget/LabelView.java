...
public class LabelView extends View {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mMinSize = ta.getDimension(R.styleable.LabelView_label_min_size, mFillTriangle ? dp2px(35) : dp2px(50));
        mPadding = ta.getDimension(R.styleable.LabelView_label_padding, dp2px(3.5f));
        mGravity = ta.getInt(R.styleable.LabelView_label_gravity, Gravity.TOP | Gravity.LEFT);
        ta.recycle();
    }
